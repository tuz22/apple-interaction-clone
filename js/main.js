  ...
  const sceneInfo = [
    {
      ...
      values: {
        ...
        messageA_opacity_in: [0, 1, { start: 0.1, end: 0.2 }],
				...
				messageA_translateY_in: [20, 0, { start: 0.1, end: 0.2 }], // 시작값 20%, 끝값 0%, 타이밍
    ...
    switch (currentScene) {
      case 0:
        ...
        if (scrollRatio <= 0.22) {
          ...
          objs.messageA.style.transform = `translate3d(0, ${calcValues(values.messageA_translateY_in, currentYOffset)}%, 0)`; // 20%
				} else {
					// out
      ...
      case 3:
        ...
        // getBoundingClientRect(); 화면상에 있는 오브잭트의 크기와 위치를 가져옴
        ...
        if (scrollRatio < values.rect1X[2].end) {
          ...
          values.blendHeight[2].start = values.rect1X[2].end; //두번째 이미지 시작지점 = 첫번째 이미지 끝지점
